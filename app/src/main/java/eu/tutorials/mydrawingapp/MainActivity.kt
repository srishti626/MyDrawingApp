...
class MainActivity : AppCompatActivity() {
        ...
        withContext(Dispatchers.IO) {
            if (mBitmap != null) {
                ...
                try {
                    ...
                    // The buffer capacity is initially 32 bytes, though its size increases if
                    // necessary.
                    ...
                    // getExternalStorageDirectory : returns the primary shared/external
                    // storage directory.
                    ...
                    val fo =
                        FileOutputStream(f) // Creates a file output stream to write
                    // to the file represented by the specified object.
                    fo.write(bytes.toByteArray()) // Writes bytes from the specified
                    // byte array to this file output stream.
                    fo.close() // Closes this file output stream and releases
    ...
    private fun shareImage(result:String){
        ...
        MediaScannerConnection.scanFile(
            ...
            // that is displayed by the system when you try to start an activity
            // with multiple possible matches,
